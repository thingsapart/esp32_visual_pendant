...
#define QUEUE_LENGTH 25 // How many gcode commands to queue up before dropping.
                            ...
                            )
    {
        ...
        // TODO: consider moving to higher up so it is clear the queue is owned by higher level processing
...
#ifdef ESP32_HW
            // TODO: if we move up the create we would want to move up the delete too so we then manage it fully there.
