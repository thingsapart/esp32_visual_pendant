...
machine_position_wcs_t *
machine_position_wcs_create(lv_obj_t *parent, const char **coords,
                            size_t num_coords, interface_t *interface,
                            int digits, const char **coord_systems,
