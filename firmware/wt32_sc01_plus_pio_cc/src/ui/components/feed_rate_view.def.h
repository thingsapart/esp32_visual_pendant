...
def_view(
    ...
    components(
        ...
        container(right,
            ...
            component(override_lbl, label, style(override_lbl, __text("Over"))),
    ...
    layout(
        ...
        _layout_grid(self->main_cont, 
            ...
            style(self->main_cont, __max_client_area(), __bg_color_hex(0xff0000), __height(lv_pct(100)), __bg_opa(LV_OPA_100)),
            style(self->identifier, __bg_color_hex(0xff00ff), __bg_opa(LV_OPA_100)),
            style(self->value, __min_width(lv_pct(50))),
            style(self->bars, __bg_color_hex(0xff2255), __bg_opa(LV_OPA_100), __min_width(20), __min_height(30)),
        ...
        _layout_v(self->left_mid, LV_FLEX_ALIGN_START,
            ...
            style(self->left_mid, __bg_color_hex(0x00ffff), __bg_opa(LV_OPA_100))
        ),
