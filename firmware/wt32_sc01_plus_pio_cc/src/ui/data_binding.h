...
/**
 * @brief Creates and initializes the CNC UI ViewModel.
 *
 * @param machine A pointer to an initialized machine_interface_t.
 * @return A pointer to the new cnc_ui_viewmodel_t instance.
 */
cnc_ui_viewmodel_t* cnc_ui_viewmodel_create(machine_interface_t* machine);

/**
 * @brief Destroys the ViewModel.
 */
