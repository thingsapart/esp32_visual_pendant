...
static inline int thrd_create(thrd_t *thr, thrd_start_t func, void *arg) {
    _thrd_wrapper_arg* wrapper_arg = (_thrd_wrapper_arg*)calloc(1, sizeof(_thrd_wrapper_arg));
    if (wrapper_arg == NULL) {
        return thrd_nomem;
    }
...
#else
// For other platforms (like Linux or Windows with a modern GCC/Clang), just include the standard header.
#include <threads.h>
#endif // __APPLE__
